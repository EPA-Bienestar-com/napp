              ...
              <div className="space-y-6 py-6 px-5">
                ...
                <div>
                  <p className="mt-6 text-center text-base font-normal text-gray-500">
                    Ya tiene una cuenta?
                    <Link to="/signin" className="ml-6 text-green-600 hover:text-green-500">
                      Ingresar!
                    </Link>
                  <Link
                    to="/register"
                    className="flex w-full items-center justify-center rounded-md border border-transparent bg-green-600 px-4 py-2 text-base font-normal text-white shadow-sm hover:bg-green-700"
                  >
